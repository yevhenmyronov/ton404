...
Воно показане на сторінці окремим рядком, і **в байтах, а не у відсотках маси**.
Маса ∝ √байтів, тож −1% маси це −1.99% байтів: людину цікавить не відсоток, а
скільки треба донести, щоб діра просто лишилась на місці. Плутанина між цими
двома величинами — та сама підміна, на якій довго стояла помилка в тексті про
температуру, тому обидві перевіряються в `?test`.

Звідси й головний наслідок для проєкту: діра **не накопичувач, а резервуар**.
Стеля — приблизно 50× добового притоку, бо саме там втрата зрівнюється з
годуванням. При 1 ГБ/добу вона зупиниться на 50 ГБ, при 10 ГБ/добу — на 500 ГБ.
