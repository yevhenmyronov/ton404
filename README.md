...
розмазує згодоване: на цілі сезону це 1.5·10⁸⁷ бітів проти 1.4·10¹⁶ кинутих.
...
- **колір диска — false colour.** Закон T ∝ M<sup>−1/4</sup> справжній, і сторінка
  показує справжню температуру диска (10⁶–10⁷ K). Але це рентген, око його не
  бачить, а наближення Планка в RGB валідне лише 1000–40000 K. Тому справжня
